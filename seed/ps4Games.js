...
const products = [
    new Product({
        ...
        platform: "Ps4",
        price: 25,
        coverImage: "/images/games/pc/batman.jpg",
    }),
    new Product({
        title: "Dark Souls",
        description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam tristique magna mauris, eu pharetra justo aliquet sed. Vestibulum convallis diam sit amet augue luctus ultricies. Cras sagittis volutpat nisi quis dignissim. Nunc blandit mi eget arcu dictum, ut euismod mi sodales. ",
        platform: "Ps4",
        price: 45,
        coverImage: "/images/games/pc/dark.png",
    }),
    new Product({
        ...
        platform: "Ps4",
        price: 85,
        coverImage: "/images/games/pc/evil.jpg",
    }),
    new Product({
        ...
        platform: "Ps4",
        price: 95,
        coverImage: "/images/games/pc/metal.jpg",
    }),
    new Product({
        ...
        platform: "Ps4",
        price: 80,
        coverImage: "/images/games/pc/mortal.jpg",
    }),
    new Product({
        ...
        platform: "Ps4",
        price: 70,
        coverImage: "/images/games/pc/street.jpg",
    }),
];
